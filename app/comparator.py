...
class LabelComparator:
    def __init__(self, pass_threshold: float = 0.80, review_threshold: float = 0.65):
        self.pass_threshold = pass_threshold
        self.review_threshold = review_threshold

    def compare_field(self, field_name: str, expected: str, extracted: str, ocr_confidence: float) -> Dict[str, Any]:
        ...
        if not extracted or extracted.strip() == "":
            # Proof is optional on labels when ABV % is present
    ...
    def validate_government_warning(self, expected: str, extracted_text: str) -> Dict[str, Any]:
    ...
    def evaluate_application(self, metadata: Dict[str, str], ocr_results: Dict[str, Any]) -> Dict[str, Any]:
        """Evaluates all fields and computes final overall application compliance decision."""
        field_results = {}
        raw_text = ocr_results.get("raw_text", "")
        extracted_fields = ocr_results.get("fields", {})
        ...
        return {
            ...
            "ocr_engine_used": ocr_results.get("engine_used", "Local OCR"),
            "processing_time_seconds": ocr_results.get("processing_time_seconds", 0.0)
        }
